...
class MoiveSpider(CrawlSpider):
    ...
    def parse_item(self,response):
        ...
        item['rating_num']=sel.xpath('//*[@id="interest_sectl"]/div[1]/div[2]/strong/text()').extract()
        item['rating_people']=sel.xpath('//*[@id="interest_sectl"]/div[1]/div[2]/div/div[2]/a/span/text()').extract()
        item['summary']=sel.xpath('//*[@id="link-report"]/span[1]').xpath('string(.)').extract()
        tag_list = sel.xpath('//*[@class="tags-body"]/*[text()]/text()').extract()
